...
typedef struct {
    ngx_hash_t       *hash;
    ngx_hash_key_pt   key; // gen hash func

    ngx_uint_t        max_size; // hash table bucket num
    ngx_uint_t        bucket_size; // everyone bucket max size

    char             *name; // hash table name
    ngx_pool_t       *pool;
    ngx_pool_t       *temp_pool; // temp pool
} ngx_hash_init_t;
