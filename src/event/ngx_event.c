...
// ngx_timer_resolution 为用户配置的参数值，
// 即ngx_timer_resolution时间过后，必须进行时间的更新
// nginx cache 时间，避免频繁gettimeofday 这类系统调用
...
ngx_event_process_init(ngx_cycle_t *cycle)
{
	...
	// find use指令选出的module（eg use epoll) init
    ...
    next = NULL;
	// connections 加入free_connections
    do {
        i--;
