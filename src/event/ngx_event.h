...
//ref: http://my.oschina.net/fqing/blog/83516
struct ngx_event_s {
	// 将要关联的模型，connection, ... 或其它
    void            *data;
...
//ref http://blog.csdn.net/freeinfor/article/details/16343223
typedef struct {
	// 对应worker_connections或connections配置项 
